...
-->
# Loomground Topos — model, rationale, caveats

The README as it stood before 2026-09-09, verbatim (its own SPDX header omitted). The normative text is `spec/SPEC.md`; the README is the entry point.
